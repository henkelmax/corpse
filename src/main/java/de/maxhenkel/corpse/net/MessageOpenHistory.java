...
public class MessageOpenHistory implements Message<MessageOpenHistory> {
    ...
    public static final CustomPacketPayload.Type<MessageOpenHistory> TYPE = new CustomPacketPayload.Type<>(Identifier.fromNamespaceAndPath(CorpseMod.MODID, "open_history"));
